...
def user_input_features():
    ticker = st.sidebar.text_input("Ticker", 'AAPL')#Symbols are self declarated
...
st.header(f"Adjusted Close Price\n {company_name}") # adjusting the closing price, it will show one last day from today
...
# Plot the chart for exponential averages
